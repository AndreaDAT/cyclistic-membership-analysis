...
![Análisis de membresía Cyclistic](ciclystic.PNG)
...
Transformación y consultas en SQL para segmentación y creación de variables adicionales.

Análisis exploratorio del comportamiento de uso (frecuencia, duración, tipo de usuario).
...
Recomendaciones enfocadas en estrategias de marketing segmentado.

Propuesta de acciones para incentivar la membresía anual.
